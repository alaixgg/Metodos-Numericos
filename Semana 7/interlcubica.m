...
%Configuramos las ecuaciones para hallar los coeficientes del interpolante cubico
...
%Determinemos los coeficientes del interpolante cubico
A=inv(M)*Y;
z=sym('z');
a0=sym('a0');
a1=sym('a1');
...
%Presentamos los resultados de la interpolacion cubica.
disp(sprintf('\nINTERPOLACIÓN CUBICAA:'))
disp(sprintf('\nDatos elegidos para x: x1 = %g, x2 = %g, x3 = %g, x4 = %g',xdata(1),xdata(2),xdata(3), xdata(4)))
disp(sprintf('\nDatos elegidos para y: y1 = %g, y2 = %g, y3 = %g, y4 = %g',ydata(1),ydata(2),ydata(3), xdata(4)))

% Presentamos los coeficientes determinados a0, a1, a2, a3.
disp(sprintf('\nCoeficientes de la interpolación cuadratica: a0 = %g, a1 = %g, a2 = %g, a3 = %g',A(1),A(2),A(3),A(4)))

% Reemplazamos estos coeficientes en nuestra ecuación cuadratica para obtener el
% valor de y, que en nuestro ejemplo es la velocidad para t=16 segundos
y=A(1) + A(2)(xdesired) + A(3)(xdesired^2) + A(4)*(xdesired^3)
